...
object ThreeActorCountdown extends App 
{
  ...
  val actor1 = system.actorOf(Props[CountingActor], "Matthew")
  val actor2 = system.actorOf(Props[CountingActor], "Paul")
  val actor3 = system.actorOf(Props[CountingActor], "Nick")
